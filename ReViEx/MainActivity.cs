...
namespace ReViEx
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        private ListView _employeeNameList;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            _employeeRecyclerView = FindViewById<RecyclerView>(Resource.Id._employeeRecyclerView);
            _employeeNameList = FindViewById<ListView>(Resource.Id._employeeList);
